...
export interface MosaicGovernorInterface extends utils.Interface {
  functions: {
    ...
    "proposeWithDetails(address[],uint256[],bytes[],string,string,uint256,string)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "proposeWithDetails",
    values: [
      string[],
      BigNumberish[],
      BytesLike[],
  ...
  events: {
    ...
    "ProposalDetails(uint256,uint256,string,uint256,string)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "ProposalDetails"): EventFragment;
...
export type ProposalDetailsEvent = TypedEvent<
  [BigNumber, BigNumber, string, BigNumber, string],
  {
    proposalId: BigNumber;
    incrementingId: BigNumber;
    uri: string;
    imageIndex: BigNumber;
    action: string;
  }
>;

export type ProposalDetailsEventFilter = TypedEventFilter<ProposalDetailsEvent>;
...
export interface MosaicGovernor extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MosaicGovernorInterface;
  ...
  filters: {
    ...
    "ProposalDetails(uint256,uint256,string,uint256,string)"(
      proposalId?: null,
      incrementingId?: null,
      uri?: null,
      imageIndex?: null,
      action?: null
    ): ProposalDetailsEventFilter;
    ProposalDetails(
      proposalId?: null,
      incrementingId?: null,
      uri?: null,
